...
## 📑 Table of Contents
- [🛡 Wazuh FIM + Active Response](#-wazuh-fim--active-response)
  ...
  - [4. How to Configure Automatic Malware Deletion](#4-how-to-configure-automatic-malware-deletion)
    - [4.1 Enable FIM Monitoring on the Agent](#41-enable-fim-monitoring-on-the-agent)
    - [4.2 Enable VirusTotal Integration & Register Script on the Manager](#42-enable-virustotal-integration--register-script-on-the-manager)
    - [4.3 Create the Malware Removal Script on the Agent](#43-create-the-malware-removal-script-on-the-agent)
...
![Active Response Workflow](./docs/active-response-workflow.png)
...
![Wazuh Dashboard response in Threat Hunting](./docs/threat-hunting-dashboard.png)
